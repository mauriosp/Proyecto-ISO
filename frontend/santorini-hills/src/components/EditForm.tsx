  ...
  const EditForm = () => {
    ...
    return (
      <form className="flex flex-col space-y-2" onSubmit={handleSubmit(onSubmit)}>
        <div>
          <label className="form-label" htmlFor="name-input">Nombre</label>
          <FormInput
            id="name-input"
        ...
        <div>
          <label className="form-label" htmlFor="surname-input">Apellido</label>
          <FormInput
            id="surname-input"
        ...
        <div>
          <label className="form-label" htmlFor="phone-input">Celular</label>
