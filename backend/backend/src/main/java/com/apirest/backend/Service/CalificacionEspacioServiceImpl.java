...
public class CalificacionEspacioServiceImpl implements ICalificacionEspacioService {
    ...
    @Override
    public void calificarEspacio(ObjectId usuarioId, ObjectId espacioId, int puntuacion, String comentario) {
        // Buscar el espacio
        ...
        calificacion.setIdUsuarioCalifica(usuarioId);
        ...
        ObjectId avisoId = obtenerAvisoIdPorEspacio(espacioId);
