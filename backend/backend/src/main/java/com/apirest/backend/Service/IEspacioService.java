...
public interface IEspacioService {
    ...
    Espacio crearEspacio(ObjectId idUsuario, String tipoEspacio, int baños, int habitaciones, String direccion, BigDecimal area);
    Optional<Espacio> buscarEspacioPorDireccionYPropietario(String direccion, ObjectId idPropietario);
    Espacio editarEspacio(String idEspacio, String tipoEspacio, int baños, int habitaciones, String direccion, BigDecimal area);
